...

ysRadiance ysMaterialMirror::EvaluateEmittedRadiance(const ysVec4&) const
{
    ysRadiance L;
    L.m_value = ysVec4_zero;
    L.m_isFinite = true;
    return L;
}
...

ysIrradiance ysMaterialMirror::EvaluateEmittedIrradiance() const
{
    ysIrradiance E;
    E.m_value = ysVec4_zero;
    E.m_isFinite = true;
    return E;
}
...

ysDirectionalProbabilityDensity ysMaterialMirror::GenerateRandomEmission(ysVec4*, ysRadiance*) const
{
    ysAssert(false);
    ysDirectionalProbabilityDensity p;
    p.SetInvalid();
...

ysDirectionalProbabilityDensity ysMaterialMirror::ProbabilityDensityForGeneratedEmission(const ysVec4&) const
{
    ysAssert(false);
    ysDirectionalProbabilityDensity p;
    p.SetInvalid();
