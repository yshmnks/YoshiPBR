...

ys_float32 ysSafeReciprocal(ys_float32 f)
{
    return (ysAbs(f) < ys_zeroSafe) ? 0.0f : 1.0f / f;
}
...

ysVec4& operator+=(ysVec4& a, const ysVec4& b)
{
...

bool operator==(const ysVec4& a, const ysVec4& b)
{
    // https://stackoverflow.com/questions/6042399/how-to-compare-m128-types
    __m128 cmp = _mm_cmpeq_ps(a.simd, b.simd);
    ys_int32 msk = _mm_movemask_ps(cmp);
    return msk == 0xF;
}
...

bool ysIsApproximatelyNormalized4(const ysVec4& v)
{
    const ys_float32 thresh = 0.001f;
    const ys_float32 lower = (1.0f - thresh) * (1.0f - thresh);
    const ys_float32 upper = (1.0f + thresh) * (1.0f + thresh);
    ys_float32 vv = ysLengthSqr4(v);
    return lower < vv && vv < upper;
}


bool ysIsApproximatelyNormalized3(const ysVec4& v)
{
    const ys_float32 thresh = 0.001f;
    const ys_float32 lower = (1.0f - thresh) * (1.0f - thresh);
    const ys_float32 upper = (1.0f + thresh) * (1.0f + thresh);
    ys_float32 vv = ysLengthSqr3(v);
    return lower < vv && vv < upper;
}
...
{
    return ysRotate(ysConjugate(q), v);
}
...
{
    return ysInvRotate(xf.q, p - xf.p);
}


ysVec4 ysMul33(const ysMtx44& R, const ysVec4& v)
{
    return R.cx * ysSplatX(v) + R.cy * ysSplatY(v) + R.cz * ysSplatZ(v);
}


ysVec4 ysMulT33(const ysMtx44& R, const ysVec4& v)
{
    return ysVecSet(ysDot3(R.cx, v), ysDot3(R.cy, v), ysDot3(R.cz, v));
}
