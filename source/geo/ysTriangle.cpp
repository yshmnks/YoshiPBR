...

void ysTriangle::ConvertFromWSToLS(ysVec4* posLS, ysVec4* dirLS, const ysVec4& posWS, const ysVec4& dirWS) const
{
    ysMtx44 m;
    m.cx = m_t;
    m.cy = ysCross(m_n, m_t);
    m.cz = m_n;
    *dirLS = ysMulT33(m, dirWS);
    *posLS = posWS - m_v[0];
}


void ysTriangle::ConvertFromLSToWS(ysVec4* posWS, ysVec4* dirWS, const ysVec4& posLS, const ysVec4& dirLS) const
{
    ysMtx44 m;
    m.cx = m_t;
    m.cy = ysCross(m_n, m_t);
    m.cz = m_n;
    *dirWS = ysMul33(m, dirLS);
    *posWS = posLS + m_v[0];
}